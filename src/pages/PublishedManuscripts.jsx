...
const PublishedManuscripts = () => {
  ...
  const handleReadFile = async (id) => {
    try {
      ...
      // Trigger the backend endpoint which will redirect to the signed Cloudinary URL
      window.open(`${API.defaults.baseURL}/published-manuscripts/${id}/file`, "_blank");
      ...
      alert("Could not open manuscript.");
    } finally {
      setReadingId(null);
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
          ...
          <button
            ...
            className="bg-indigo-600 text-white gap-2 px-4 py-2 rounded-lg flex items-center hover:bg-indigo-700 transition"
          >
            {loading ? (
              <Loader2
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex gap-2 mt-6">
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold hover:bg-indigo-700 flex items-center justify-center gap-2 transition disabled:opacity-50"
                  >
